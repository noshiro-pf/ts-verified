...
export namespace Optional {
   ...
   * ```
   */
  export function unwrapOr<const O extends Base, D>(
    optional: O,
    defaultValue: D,
  ): D | Unwrap<O>;
   ...
   * ```
   */
  export function orElse<const O extends Base, const O2 extends Base>(
    optional: O,
    alternative: O2,
  ): O | O2;
   ...
   * ```
   */
  export function map<const O extends Base, S2>(
    optional: O,
   ...
   * ```
   */
  export function flatMap<const O extends Base, S2>(
    optional: O,
   ...
   * ```
   */
  export function filter<const O extends Base>(
    optional: O,
   ...
   * ```
   */
  export function expectToBe<const O extends Base>(
    optional: O,
    message: string,
  ): Unwrap<O>;
