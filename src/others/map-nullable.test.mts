...
describe('mapNullable', () => {
  ...
  describe('curried usage', () => {
    ...
    test('should work with pipe composition', async () => {
    ...
    test('should handle null values in pipe composition', async () => {
      const { pipe } = await import('../functional/pipe.mjs');
    ...
    test('should work with multiple transformations in pipe', async () => {
      const { pipe } = await import('../functional/pipe.mjs');
  ...
  describe('edge cases and type safety', () => {
    test('should preserve type information', () => {
      const stringResult = mapNullable('test', (s) => s.length);
      expectType<typeof stringResult, number | undefined>('=');

      const numberResult = mapNullable(42, (n) => n.toString());
      expectType<typeof numberResult, string | undefined>('=');

      const booleanResult = mapNullable(true, (b) => !b);
      expectType<typeof booleanResult, boolean | undefined>('=');
    });
  ...
  describe('practical use cases', () => {
    ...
    test('should work with form data processing', () => {
      ...
      const parseAge = mapNullable((ageStr: string) => parseInt(ageStr, 10));
