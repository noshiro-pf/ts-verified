...
/**
 * Rounds a number to a specified power of 10.
 * This is equivalent to `roundAt` but with parameters in a different order and name.
 * @param digit The exponent for the power of 10 (e.g., 2 for rounding to 2 decimal places).
