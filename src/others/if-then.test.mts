...
describe('ifThen', () => {
  it('should implement logical implication truth table', () => {
  ...
  it('should work for validation logic', () => {
  ...
  it('should work for access control logic', () => {
    const checkPermission = (isAdmin: boolean, hasPermission: boolean): boolean => {
  ...
  it('should work for contract validation', () => {
    const validateSubscription = (isPremium: boolean, hasAllFeatures: boolean): boolean => {
      // If premium, then all premium features must be enabled
      return ifThen(isPremium, hasAllFeatures);
    };
  ...
  it('should work in chaining scenarios', () => {
  ...
  it('should work with negation patterns', () => {
    const checkExpiredLogic = (isExpired: boolean, isValid: boolean): boolean => {
      ...
      return ifThen(!isExpired, isValid);
    };
